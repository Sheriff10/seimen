...
const Hero = () => {
   useEffect(() => {
      ...
      playerLeft.src = "http://localhost:3000/asset/kk.png";
      const playerRight = new Image();
      playerRight.src = "http://localhost:3000/asset/kk.png";
      class Player {
         constructor() {
            this.x = canvas.width;
         ...
         draw() {
            ...
            if (this.x >= mouse.x) {
                ...
                //     this.spriteWidth,
                //     this.spriteHeight,
                //     0 - this.spriteWidth / 200,   // Adjust the position based on the image width
                //     0 - this.spriteHeight / 200,  // Adjust the position based on the image height
                //     this.spriteWidth,           // Set the destination width
                //     this.spriteHeight           // Set the destination height
                // );
            } else {
                // ctx.drawImage(
                //     playerLeft,
                ...
                //     this.spriteWidth,
                //     this.spriteHeight,
                //     0 - this.spriteWidth / 100,   // Adjust the position based on the image width
                //     0 - this.spriteHeight / 210,  // Adjust the position based on the image height
                //     this.spriteWidth,           // Set the destination width
                //     this.spriteHeight           // Set the destination height
                // );
            }
            ...
            for (let x = 0, x2 = textCoordinates.width; x < x2; x++) {
               if (
                  ...
                  bubbleTextArray.push(
                     new Particle2(positionX * 8, positionY * 8)
                  );
               }
            }
         }
